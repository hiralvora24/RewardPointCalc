...
public class RewardsController {
    ...
    public ResponseEntity<Object> getRewardsByCustomerId(@PathVariable("customerId") Long customerId){

        Customer customer = customerRepository.findByCustomerId(customerId);
        if(customer == null)
        {
            String errorMessage = "{\"timestamp\":\"" + new Date() +"\",\"status\":"+ HttpStatus.FORBIDDEN +",\"error\": \"Customer not found\",\"path\": \"/customers/"+customerId+"/rewards\"}";
